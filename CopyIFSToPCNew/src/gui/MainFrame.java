...
public class MainFrame extends JFrame {
	...
	// private ToIFSDirectoryDialog toIFSDirectoryDialog;
	...
	public MainFrame(String company) {
		...
		toolBar = new Toolbar();
		formPanel = new FormPanel(company);
		...
		// toIFSDirectoryDialog = new ToIFSDirectoryDialog(this, "Copy To IFS Folder", false);
		
		tablePanel.setData(controller.getFiles());
		
		prefs = Preferences.userRoot().node("CopyIFSToPC" + company);
		...
		if(systemName.isEmpty()) {
			...
			as400 = new AS400(systemName, user, password);
		}
		try {
		...
		if (company.equals("hibbett")) prefs.put("password", "Kr@m71304");
		if (company.equals("peterstevens")) prefs.put("password", "Kr@m7713");
		if (company.equals("dmbowman")) prefs.put("password", "Kr@m7717");
