...
public class MainFrame extends JFrame {
	...
	public SimpleDateFormat getmDCYSDF() {
		return mDCYSDF;
	}

	public void setmDCYSDF(SimpleDateFormat mDCYSDF) {
		this.mDCYSDF = mDCYSDF;
	}
	
	public SimpleDateFormat getcYMDSDF() {
		return cYMDSDF;
	}

	public void setcYMDSDF(SimpleDateFormat cYMDSDF) {
		this.cYMDSDF = cYMDSDF;
	}
