...
public class MainFrame extends JFrame {
	...
	private void CloseProgram(String where) {
		...
		System.out.println(prefs.get("currentIFSDirectory", ""));
	...
	public String[] parseXMLConfig() {
		...
		try {
			 File inputFile = new File("config/CopyIFSToPC.xml");
			 DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
			 DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
			 Document doc = dBuilder.parse(inputFile);
			 doc.getDocumentElement().normalize();
			 NodeList nList = doc.getElementsByTagName("iseries_parameters");
